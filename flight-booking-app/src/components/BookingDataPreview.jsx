    ...
    <div className="table-container">
      <table className="booking-table">
        ...
        <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
          {state?.map((info) => (
            <tr key={info.id} className="lws-bookedTable text-black">
              <td className="px-6 py-4">
                <div className="flex items-center space-x-3">
                  <p className="lws-bookedFrom">{info.destinationFrom}</p>
                </div>
              </td>
              <td className="px-6 py-4">
                <p className="lws-bookedTo">{info.destinationTo}</p>
              </td>
              <td className="px-6 py-4 text-center">
                <p className="lws-bookedDate">{info.journeyDate}</p>
              </td>
              <td className="px-6 py-4 text-center">
                <p className="lws-bookedGustes">{info.guests}</p>
              </td>
              <td className="px-6 py-4 text-center">
                <span className="lws-bookedClass"> {info.classType} </span>
              </td>
              <td className="px-6 py-4 text-center">
